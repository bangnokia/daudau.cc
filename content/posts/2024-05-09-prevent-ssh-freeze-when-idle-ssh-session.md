...
I had a problem with my SSH session. It always froze when I left it idle for a while, and I had to close the terminal and open a new one to reconnect. It was very annoying, so I decided to find a solution.
